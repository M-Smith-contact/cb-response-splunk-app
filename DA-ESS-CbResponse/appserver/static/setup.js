...
function return_status_banner() {
    return '<div id="info_banner" class="info">Successfully updated configuration for add-on "DA-ESS-CbResponse". </div>' +
    '<div id="save_err_banner" class="error">Fail to update configuration for add-on "DA-ESS-CbResponse". </div>' +
    '<div id="load_err_banner" class="error">Fail to load configuration for add-on "DA-ESS-CbResponse". </div>';
}
...
function return_page() {
    return '<div class="entityEditForm"><div class="formWrapper">' +
                '<div class="fieldsetWrapper" id="cburl_SettingId">' +
                    '<fieldset>' +
                        '<legend>Cb Response Server URL</legend>' +
                ...
                '<div class="fieldsetWrapper" id="apikey_SettingId">' +
                    '<fieldset>' +
                        '<legend>Cb Response Server Global Administrator API Key</legend>' +
                        '<div class="widget" style="display: block;">' +
                            '<label></label>' +
                            '<div>' +
...
// begin to process the doc
    ...
    function appConfigured() {
        $.ajax({
            url: "/en-US/splunkd/__raw/services/apps/local/DA-ESS-CbResponse",
            type: "POST",
            data: {
                "configured": true
            }
    ...
    function saveSettings() {
        ...
        $.ajax({
            url:"/en-US/splunkd/__raw/servicesNS/-/DA-ESS-CbResponse/DA-ESS-CbResponse_input_setup/DA-ESS-CbResponse_settings/DA-ESS-CbResponse_settings",
            type: "POST",
            data: {
