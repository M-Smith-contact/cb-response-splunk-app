...
class ConfigApp(admin.MConfigHandler):
    ...
    def _updateGlobalSettings(self, stanza, all_settings,
        ...
        if self._configChanges(global_settings, all_origin_settings.get(stanza, {})):
            ...
            if conf_mgr.stanza_exist(c.myta_conf, stanza):
                conf_mgr.update_stanza(c.myta_conf, stanza, global_settings)
            else:
                conf_mgr.create_stanza(c.myta_conf, stanza, global_settings)
